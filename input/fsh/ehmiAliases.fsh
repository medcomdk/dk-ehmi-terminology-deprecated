Alias: $EHMIAuditEventTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-types
Alias: $EHMIAuditEventSubTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-sub-types
Alias: $EHMIAuditEventSubTypesValueset = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-sub-types
Alias: $EHMIAuditEventOutcome = http://hl7.org/fhir/audit-event-outcome
Alias: $EHMIAuditEventSourceType = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-source-type
Alias: $EHMIAuditEventParticipationRoleType = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-participationroletype
Alias: $EHMIAuditEventAgentWhoIdentifierTypes = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-agent-who-identifier-types
Alias: $EHMIAuditEventEntityType = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-type
Alias: $EHMIAuditEventEntityDetailType = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-detail-type
Alias: $EHMIAuditEventValueSet = http://medcomehmi.dk/dk-medcom-ehmi-terminology/CodeSystem/EHMIAuditEventValueSet
...
Alias: $EHMIAuditEventEntityMessageType = http://medcomehmi.dk/ig/dk-medcom-ehmi-terminology/CodeSystem/ehmi-auditevent-entity-message-type
